    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <font id="title" color="skyblue"><b>K.P.H.S Shilhauri Saran</b></font><br>High School,78%<br>2010 - 2012
                </div>
                <div class="col-md-4">
                    <font id="title" color="skyblue"><b>Tapeshwar singh college chapra</b></font>
                </div>
            </div>
        </div>
        <br>
