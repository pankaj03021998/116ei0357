  ...
  <head>
    ...
    <body>
        ...
        <div class="container">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav navbar-right" style="color: blue">
                        <li><a href="login_new.php" style="font-family:serif;"><font color="white" id="navcol"><span class="glyphicon glyphicon-log-in"></span><b> LOGIN</b></font></a></li>
                    </ul>
        </div>
      </div>
      </div>
        ...
        <div id="banner_image">
          ...
          <input type="password" id="password1" class="form-control" placeholder="Password" value="" required name="password" autosave="off">
